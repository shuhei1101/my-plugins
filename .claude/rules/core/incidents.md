...
| 2026-05-24 | フックの `hooks/prompts/*.md` プロンプトファイルを JP ミラーなしで作成した。ユーザー指摘後に追加作業が発生。プロンプトファイル作成時は必ず同コミットで `*.jp.md` を作成すること | [detail](../../references/incidents/hook-prompts-missing-jp-mirror.md) |
