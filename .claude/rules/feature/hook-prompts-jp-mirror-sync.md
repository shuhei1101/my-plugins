...
---
<!-- Generated by claude-kit/rule-creator v3.19.1 -->
...
フックプロンプトファイル（`hooks/prompts/*.md`）はフック実行時に Claude のコンテキストへ注入される指示文。
英語版だけ更新すると JP ミラーと内容が乖離し、日本語で参照するユーザーが古い仕様を参照し続ける原因になる。
