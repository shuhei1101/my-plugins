...
> ⚠️ **Japanese mirror** — Claude には読み込まれません。このファイルを更新する際は、必ず英語オリジナル `.claude/rules/workspace-todo-template-sync.md` も同時に更新してください。

# workspace TODO テンプレート同期ルール

## 概要

workspace の TODO.md テンプレートと work-start スキルの Step 7 を同期させるルール。
...
| ファイルパス | 役割 |
|---|---|
| `plugins/workspace/templates/TODO.md` | workspace インストール時の参照テンプレート |
| `plugins/workspace/templates/.work/tasks/yyyymmdd_xxx/PRXXX/TODO.md` | `.work/` フォルダ内の example テンプレート |
| `plugins/workspace/skills/work-start/SKILL.md` | TODO.md の記入手順を定義するスキル（Step 7） |
