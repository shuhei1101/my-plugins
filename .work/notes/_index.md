...
| 9 | [YAMLデータストア切り替え.md](コーディング規約・スタイル/YAMLデータストア切り替え.md) | ローカル開発 YAML データストア — 関数ごとの type 定義による実装切り替え |
...
| 4 | [dev-kit-index-jp-mirror-misentry.md](バグ・不具合/dev-kit-index-jp-mirror-misentry.md) | dev-kit _index.yaml JP mirror 誤登録修正 — E2Eテスト.jp.md エントリ削除 |
...
| # | ファイル | タイトル |
|---|---|---|
| 1 | [dev-kit/ref-frontmatter移行.md](dev-kit/ref-frontmatter移行.md) | dev-kit: リファレンスフロントマター方式への移行（v4.16.0） |
