...
|---|---|---|
| 1 | - | QA を `## QA` に記録する |
| 2 | - | ノートを `.work/notes/` に作成・更新する |
| 3 | - | `ref-inject` テンプレートの `inject_references.py` を更新（TRUTHY + キルスイッチ前置き） |
| 4 | - | `ref-inject` テンプレートの `_common.py` コメントを更新 |
| 5 | - | コンシューマー 3 件の `_common.py` コメントを更新（テンプレートに合わせる） |
| 6 | - | ルール / CLAUDE.md を確認・更新 |
