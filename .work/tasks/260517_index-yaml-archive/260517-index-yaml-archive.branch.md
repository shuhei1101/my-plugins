...
| 済 | merge スキルに trim 自動実行ステップを追加（案B） | - `plugins/work-kit/skills/merge/SKILL.md`<br>- `plugins/work-kit/skills/merge/SKILL.jp.md` |
| 済 | CLAUDE.md/jp.md に index.archive.yaml の説明を追記 | - `plugins/work-kit/templates/.work/CLAUDE.md`<br>- `plugins/work-kit/templates/.work/CLAUDE.jp.md` |
| 済 | プロジェクトの .work/tasks/.gitignore に index.archive.yaml を追記（既存プロジェクト対応） | - `.work/tasks/.gitignore` |
