...
| 済 | `plugins/py-kit/rules/` フォルダを削除（プラグイン内にルールテンプレートは持たない） | - `plugins/py-kit/rules/class-structure.md`<br>- `plugins/py-kit/rules/config-source-link.md`<br>- `plugins/py-kit/rules/source-test-link.md` |
| 済 | `py-new-project` Step6 を修正: テンプレートコピーではなく `/claude-kit:rule-creator` を使う指示に変更 | - `plugins/py-kit/skills/py-new-project/SKILL.md`<br>- `plugins/py-kit/skills/py-new-project/SKILL.jp.md` |
