...
| ファイル名 | 新規/編集 | 内容 | 補足 |
|---|---|---|---|
| `plugins/**/skills/*/SKILL.jp.md` | 編集 | セクション名の日本語化・サブエージェントマーカー追加 | 全36件 |
| `plugins/{claude-kit,dev-kit,ref-inject,work}/.claude-plugin/plugin.json` | 編集 | バージョンバンプ | 3.43.3 / 4.6.1 / 1.6.1 / 2.47.1 |
| `.claude-plugin/marketplace.json` | 編集 | バージョンバンプ | 全4プラグイン反映 |
