...
| 完了 | 作業内容 | 対象ファイル |
|---|---|---|
| 済 | QA.md に未決定事項を記録する（未決定事項なし） | - `.work/tasks/.../PR176/QA.md` |
| 済 | impl-review SKILL.md の Step 4 をバッチ方式に書き換える | - `plugins/workspace/skills/impl-review/SKILL.md` |
| 済 | impl-review SKILL.jp.md の同箇所も更新 | - `plugins/workspace/skills/impl-review/SKILL.jp.md` |
| 済 | バージョンバンプ + changelog | - `plugins/workspace/.claude-plugin/plugin.json` / `changelogs/v2.40.0.md` / `marketplace.json` |
