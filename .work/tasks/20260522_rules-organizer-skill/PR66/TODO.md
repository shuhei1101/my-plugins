# PR66 — rules-organizer-skill

## 概要

`.claude/rules/` フォルダをコードベースに合わせて整理する `claude-kit:rules-organizer` スキルを新規作成する。
コアとフィーチャーを必須フォルダとし、任意フォルダを提案・確認後に実行する汎用スキル。
...
- `.work/specs/rules-organizer.md`: スキル設計仕様
