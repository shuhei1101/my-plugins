...
| - | 要素ピッカーを多選択 + コピーペイロード共通化に変更(elements 配列を通常コピーに合流。XPath は short 固定) | - `plugins/ui-kit/skills/debug-fab/templates/uidev.css`, `uidev.js`, `CLAUDE.md`, `CLAUDE.jp.md`, `SKILL.md`, `SKILL.jp.md` |
