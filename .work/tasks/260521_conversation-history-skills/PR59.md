# PR59 — conversation-history-skills

## 概要

claude-kit プラグインに、会話履歴を活用して自動的にルールまたはスキルを生成する2つのスキルを追加する。
...
- `plugins/claude-kit/skills/rule-creator/SKILL.md`: ルール作成スキルの構造参考
- `plugins/claude-kit/skills/skill-creator/SKILL.md`: スキル作成スキルの構造参考
