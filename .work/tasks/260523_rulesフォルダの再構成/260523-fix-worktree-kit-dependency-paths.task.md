# PR77 — fix-worktree-kit-dependency-paths

## 概要

`worktree-kit-dependency.md` に `paths:` frontmatter がなく、自動ロードされない状態を修正する。
`plugins/work-kit/skills/work-start/SKILL.md` と `plugins/worktree-kit/skills/work-add/SKILL.md` を触ったときにロードされるよう設定する。
...
- `.work/specs/rules-organizer.md`: claude-refactor スキル設計仕様
