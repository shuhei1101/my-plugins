...
| 完了 | 作業内容 | 対象ファイル |
|---|---|---|
| 済 | `templates/.work/CLAUDE.jp.md` の `notes/` セクションに立ち位置説明を追記 | - `plugins/work-kit/templates/.work/CLAUDE.jp.md` |
| 済 | `templates/.work/CLAUDE.md` に同内容を英語で追記 | - `plugins/work-kit/templates/.work/CLAUDE.md` |
| 済 | `work-kit:notes-to-claude` スキルを作成（SKILL.md） | - `plugins/work-kit/skills/notes-to-claude/SKILL.md` |
| 済 | SKILL.jp.md を作成 | - `plugins/work-kit/skills/notes-to-claude/SKILL.jp.md` |
