<!-- This file is a Japanese mirror of 記述ルール.md. When updating the English original, update this file too. -->
# ルール作成ガイド
...
注入されたら、これに従ってルールを直接執筆すること。`共通ガイド.md` を併読すること。
英語原本: `references/claude-md/記述ルール.md`
...
（手作業または `jp-mirror-translator` エージェントで）作る。両方にスタンプを付ける（`共通ガイド.md` 参照）。
