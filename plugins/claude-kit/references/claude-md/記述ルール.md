...
a rule file), follow it to author the rule directly. Read `共通ガイド.md` alongside it.
Japanese mirror: `references/claude-md/記述ルール.jp.md`
...
(by hand or via the `jp-mirror-translator` agent). Stamp both (see `共通ガイド.md`).
