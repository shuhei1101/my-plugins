...
Outputs plain text to stdout — injected as `<system-reminder>` before Claude processes the prompt.
...
**Editing: add keyword filtering** (fire only when the prompt matches a condition):
