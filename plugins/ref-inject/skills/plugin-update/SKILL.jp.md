...
1. `git rev-parse --abbrev-ref HEAD` を実行する
...
- 現在のブランチが `master` / `main` でないことを確認

---

### ステップ2: コンシューマープラグインを列挙
