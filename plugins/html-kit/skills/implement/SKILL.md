---
name: html-kit:implement
description: >
  Implement a UI screen — turn a mock (from html-kit:mock) or a feature request into real code.
...
# html-kit:implement — Screen Implementation Workflow
...
- This skill assumes a mock already exists or the feature spec is clear. If neither, run
  `/html-kit:mock` first to gather feedback before committing to implementation.
