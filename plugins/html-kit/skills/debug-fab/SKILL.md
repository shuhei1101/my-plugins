...
# html-kit:debug-fab — Floating Debug Button
...
Confirm the project follows `html-kit:logging` conventions:
...
If the project does not yet have a logger, run `/html-kit:logging` first.
