...
# SKILL.jp.md — html-kit:logging(日本語ミラー)
...
```
{plugin_root}/references/principles.md   # セクション 3(JS 規約)とセクション 1(DRY)
```
...
- `{plugin_root}/references/principles.md` — セクション 3(JS 規約)とセクション 1(共通化)
