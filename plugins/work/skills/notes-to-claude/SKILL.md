...
# work:notes-to-claude — Promote Notes to Permanent Knowledge
...
|---|---|---|
| `work:notes-to-claude` (this skill) | `.work/notes/` temporary memos | Populate `.claude/` with new knowledge |
