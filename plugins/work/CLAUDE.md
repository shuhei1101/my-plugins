...
|---|---|---|---|
| 1 | 2.57.0 | 2026-05-31 | Add `work:setup-wizard` skill and `SessionStart` hook (`setup_check.py`); first-run onboarding completes when `setup_done: true` is written to `.claude/work.local.md` |
