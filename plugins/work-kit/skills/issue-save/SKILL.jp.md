...
---
<!-- Generated by work-kit/issue-save v2.33.0 -->
...
1. `/claude-kit:mark-generated --plugin work-kit --skill issue-save --file .work/issues/ISSUE-{N}.md`
   を呼び出して provenance メタデータコメントを取得する
2. `.work/issues/ISSUE-{N}.md` を以下の構造で作成する。冒頭にメタデータコメントを置く:

   ```markdown
   <!-- Generated by work-kit/issue-save v{version} -->
...
- `.work/issues/ISSUE-{N}.md` が provenance メタデータ付きで作成済み
