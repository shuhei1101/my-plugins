...
1. Invoke `/claude-kit:mark-generated --plugin work-kit --skill issue-save --file .work/issues/ISSUE-{N}.md`
   to get the provenance metadata comment string
2. Create `.work/issues/ISSUE-{N}.md` with this structure, placing the metadata comment at the top:
...
- `.work/issues/ISSUE-{N}.md` created with provenance metadata
