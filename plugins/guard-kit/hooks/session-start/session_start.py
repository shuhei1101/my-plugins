...
def _build_context() -> dict:
    ...
    # 各フックが参照する env 名と既定値
    raw_protected = os.environ.get("GUARD_KIT_PROTECTED_BRANCHES")
