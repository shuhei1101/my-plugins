...
echo "export GH_KIT_LABEL_PROCESSING_PR_DRAFT=processing:pr-draft" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_PROCESSING_PR_IMPLEMENT=processing:pr-implement" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_PROCESSING_PR_REVIEW=processing:pr-review" >> "$CLAUDE_ENV_FILE"
...
echo "export GH_KIT_LABEL_PRIORITY_HIGH=priority:high" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_PRIORITY_MEDIUM=priority:medium" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_PRIORITY_LOW=priority:low" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_COLOR_PRIORITY_HIGH=B60205" >> "$CLAUDE_ENV_FILE"
echo "export GH_KIT_LABEL_COLOR_PRIORITY_MEDIUM=E4E669" >> "$CLAUDE_ENV_FILE"
