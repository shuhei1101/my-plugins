...
cat "${CLAUDE_PLUGIN_ROOT}/templates/レビュー結果コメント.md.j2"
...
人間起票で **本文に欠けているセクション** があるときに限り、`イシュードキュメント.md.j2` に
...
ステップ 1 で取得した `レビュー結果コメント.md.j2` に沿って実装方針 / 質問 / 分割提案 / 影響範囲を書く。
