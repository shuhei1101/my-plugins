...
See `architecture/layout.md` for details.
...
`AppError` family is converted to HTTP by `register_exception_handlers` (`shared/errors.md`).
...
- `fastapi/schemas.md` — How to build ChatRequest / ChatResponse
- `fastapi/auth-and-errors.md` — Depends + exception_handler
- `fastapi/app.md` — Overall application composition
- `architecture/layout.md` — Where route.py sits
