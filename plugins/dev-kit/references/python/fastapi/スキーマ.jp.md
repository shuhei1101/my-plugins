<!-- This file is a Japanese mirror of スキーマ.md. When updating the English original, update this file too. -->
# fastapi/schemas — 入出力 Pydantic スキーマ

> このファイルは `スキーマ.md` の日本語ミラーです。
...
- `fastapi/ルート定義.md` — schemas を使った route 実装
- `architecture/TypeScriptスタイル適用.md` — 内部 DTO (@dataclass) のスタイル
- `core/コメント.md` — フィールド description
