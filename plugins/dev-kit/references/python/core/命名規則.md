...
- `architecture/レイアウト.md` — overall feature folder structure conventions
- `core/コメント.md` — docstring policy that goes with naming
- `architecture/TypeScriptスタイル適用.md` — concrete examples of type alias naming
