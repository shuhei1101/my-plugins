<!-- This file is a Japanese mirror of decorators.md. When updating the English original, update this file too. -->
# 推奨デコレータ + ハンドラーデコレータ

dev-kit Python で使用を推奨するデコレータ群と、横断関心事を吸収する **ハンドラーデコレータ** パターン。
