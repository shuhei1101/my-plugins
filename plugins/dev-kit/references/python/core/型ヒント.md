...
The Pydantic / dataclass / TypedDict / Protocol decision table is managed as the central section of `architecture/TypeScriptスタイル適用.md`. Not duplicated here to prevent duplication.

---

## Related files

- `core/デコレーター.md` — recommended decorators + handler decorators + `@overload`
- `architecture/TypeScriptスタイル適用.md` — DTO usage table / TypeScript-style style
- `core/言語ルール.md` — exception hierarchy / import order
- `core/コメント.md` — how to write field descriptions
