<!-- This file is a Japanese mirror of 言語ルール.md. When updating the English original, update this file too. -->
# 言語ルール

> このファイルは `言語ルール.md` の日本語ミラーです。
...
- 例外を普通に投げる
- 横断関心事（ログ・リトライ・タイムアウト・例外変換）は **ハンドラーデコレータ**で束ねる（`core/型ヒント.md` 参照）
...
- `shared/エラー定義.md` — 例外階層の詳細
- `shared/ロガー.md` — ログ運用
- `core/型ヒント.md` — ハンドラーデコレータの実装例
