...
See `shared/エラー定義.md` for details.
...
- Bundle cross-cutting concerns (logging, retry, timeout, exception mapping) into **handler decorators** (see `core/型ヒント.md`)
...
- `shared/エラー定義.md` — details of the exception hierarchy
- `shared/ロガー.md` — logging operations
- `core/型ヒント.md` — implementation examples of handler decorators
