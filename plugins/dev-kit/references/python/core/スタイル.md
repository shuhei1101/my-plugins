...
Policy for formatting and static analysis configuration. For example entries in `pyproject.toml`, see `packaging/pyproject設定.md`.
...
See `core/言語ルール.md` for details. ruff's `I` rule sorts automatically.
...
- `packaging/pyproject設定.md` — full pyproject.toml sample
- `core/言語ルール.md` — import ordering and logging
