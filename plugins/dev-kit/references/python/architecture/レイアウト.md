...
> Prompt files live in **`prompts/` directly under the project root** (see `llm/プロンプト執筆.md`).
...
See `testing/テスト戦略.md` for details.
...
See `scripts/Pythonスクリプト.md` for details.

---

## Related files

- `architecture/TypeScriptスタイル適用.md` — type aliases + function style used inside features
- `architecture/コンポジションルート.md` — responsibilities of main.py
- `architecture/依存パッケージ管理.md` — dependency direction
- `core/命名規則.md` — standard file names inside a feature
