...
- `architecture/TypeScriptスタイル適用.md` — Function type alias + injection patterns
- `architecture/レイアウト.md` — Where to place main.py
- `architecture/依存パッケージ管理.md` — Dependency direction
- `fastapi/アプリケーション.md` — FastAPI-specific setup
