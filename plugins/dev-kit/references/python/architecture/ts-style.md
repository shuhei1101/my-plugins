...
See the Recommended Decorators section in `core/type-hints.md` for implementation examples.
...
- `architecture/layout.md` — Folder structure
- `architecture/composition-root.md` — How to wire functions with partial in main.py
- `architecture/dependencies.md` — Dependency direction and DIP
- `core/naming.md` — Type alias naming conventions
- `core/type-hints.md` — PEP 695 / handler decorators / `assert_never`
