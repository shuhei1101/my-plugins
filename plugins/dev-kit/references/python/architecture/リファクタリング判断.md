...
Detailed patterns are in the "Three stages of interface abstraction" section of `architecture/TypeScriptスタイル適用.md`.
...
See also `shared/シークレットと環境変数.md`.
...
- `architecture/design-基本方針.md` — the priority of DRY > SOLID > extensibility
- `architecture/TypeScriptスタイル適用.md` — abstraction patterns (type aliases / Protocol / overload)
- `shared/シークレットと環境変数.md` — secret boundaries + placement of settings values
- `shared/定数.md` — where to put constants
