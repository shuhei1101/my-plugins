...
実装例は `core/type-hints.md` の Recommended Decorators 節を参照。
...
- `architecture/layout.md` — フォルダ構成
- `architecture/composition-root.md` — main.py で関数を partial で配線する方法
- `architecture/dependencies.md` — 依存方向と DIP
- `core/naming.md` — 型エイリアス命名規約
- `core/type-hints.md` — PEP 695 / ハンドラーデコレータ / `assert_never`
