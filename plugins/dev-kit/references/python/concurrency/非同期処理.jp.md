<!-- This file is a Japanese mirror of 非同期処理.md. When updating the English original, update this file too. -->
# concurrency/async — asyncio 規約

> このファイルは `非同期処理.md` の日本語ミラーです。
...
CPU バウンドなら `concurrency/並列処理.md` を参照。
...
- `concurrency/並列処理.md` — CPU バウンド処理
- `architecture/コンポジションルート.md` — async 起動の典型
- `core/型ヒント.md` — Awaitable / AsyncIterator の型
