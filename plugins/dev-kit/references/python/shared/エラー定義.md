...
See `fastapi/認証とエラー.md` for details.
...
Combine with handler decorators from `core/型ヒント.md`:
...
- `core/言語ルール.md` — exception messages in English
- `core/型ヒント.md` — handler decorators
- `llm/例外とリトライ.md` — LLM exception hierarchy and retry
- `fastapi/認証とエラー.md` — `exception_handler` in FastAPI
