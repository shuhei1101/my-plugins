<!-- This file is a Japanese mirror of エラー定義.md. When updating the English original, update this file too. -->
# errors — 例外階層

> このファイルは `エラー定義.md` の日本語ミラーです。
...
`core/型ヒント.md` のハンドラーデコレータと組み合わせる:
...
- `core/言語ルール.md` — 例外メッセージは英語
- `core/型ヒント.md` — ハンドラーデコレータ
- `llm/例外とリトライ.md` — LLM 例外階層とリトライ
- `fastapi/認証とエラー.md` — FastAPI での exception_handler
