...
- `core/型ヒント.md` — details on `type` statement / NewType
- `core/命名規則.md` — naming conventions for type aliases
- `architecture/依存パッケージ管理.md` — positioning of shared as a placement location
