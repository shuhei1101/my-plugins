<!-- This file is a Japanese mirror of 配布設定.md. When updating the English original, update this file too. -->
# packaging/distribution — 配布

> このファイルは `配布設定.md` の日本語ミラーです。
...
- `packaging/pyproject設定.md` — pyproject.toml の構造
- `packaging/依存パッケージ管理.md` — uv で開発
- `packaging/Pythonバージョン.md` — 対応バージョン
