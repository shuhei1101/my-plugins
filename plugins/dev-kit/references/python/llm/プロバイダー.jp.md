<!-- This file is a Japanese mirror of プロバイダー.md. When updating the English original, update this file too. -->
# llm/providers — LLM プロバイダ実装

> このファイルは `プロバイダー.md` の日本語ミラーです。
...
詳細は `concurrency/非同期処理.md` の async generator。
...
- `llm/例外とリトライ.md` — 例外 + リトライ
- `llm/コストとキャッシュ.md` — トークン管理
- `llm/prompts.md` — プロンプトファイル管理
- `architecture/TypeScriptスタイル適用.md` — 関数の型エイリアスの設計思想
