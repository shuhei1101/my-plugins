...
Log token usage before optimizing (see `llm/プロバイダー.md` for an example):
...
- `llm/プロバイダー.md` — implementation of token usage logging
- `llm/例外とリトライ.md` — rate-limit also affects cost
- `shared/ロガー.md` — cost aggregation via structured logs
