<!-- This file is a Japanese mirror of 例外とリトライ.md. When updating the English original, update this file too. -->
# llm/exceptions-retry — LLM 例外階層とリトライ戦略

> このファイルは `例外とリトライ.md` の日本語ミラーです。
...
- `shared/エラー定義.md` — 全体の例外階層
- `core/型ヒント.md` — ハンドラーデコレータの実装パターン
- `llm/プロバイダー.md` — vendor 例外のラップ
