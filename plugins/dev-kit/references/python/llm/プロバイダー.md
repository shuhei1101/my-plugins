...
See `concurrency/非同期処理.md` for async generators.
...
- `llm/例外とリトライ.md` — Exceptions + retry
- `llm/コストとキャッシュ.md` — Token management
- `llm/prompts.md` — Prompt file management
- `architecture/TypeScriptスタイル適用.md` — Design philosophy of function type aliases
