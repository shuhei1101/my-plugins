<!-- This file is a Japanese mirror of db-timestamps.md. When updating the English original, update this file too. -->
...
- `db-id.md` — 主キー設計
- `db-optimistic-lock.md` — `updatedAt` を使った楽観ロック
- `auth-schema.md` — 認証テーブルへの適用例
