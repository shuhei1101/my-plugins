<!-- This file is a Japanese mirror of 認証スキーマ.md. When updating the English original, update this file too. -->
...
- `DB-ID設計.md` — ID 設計
- `DBタイムスタンプ.md` — timestamps ヘルパー
- `DBリレーション.md` — relations 設計
- `DBマイグレーション.md` — マイグレーション運用
