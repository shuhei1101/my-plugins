<!-- This file is a Japanese mirror of db-optimistic-lock.md. When updating the English original, update this file too. -->
# Drizzle — 楽観的ロック
...
- `mode: "string"` で持っているので ISO 文字列比較になる（`db-timestamps.md`）
...
- `db-timestamps.md` — `updatedAt` カラム定義
- `error-classes.md` — `VersionConflictError`
