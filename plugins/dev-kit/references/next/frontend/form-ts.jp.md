<!-- This file is a Japanese mirror of form-ts.md. When updating the English original, update this file too. -->
...
- `frontend/form-component.md` — shadcn `<Form>` でのバインド
- `frontend/edit-screen-tsx.md` — フォーム送信
- `backend/actions-ts.md` — Server Action 側でも同じ schema を `.parse`
- `frontend/conventions/types.md` — 型導出全般
