...
paths:
  ...
  - pattern: "**/app/(authenticated)/*/[id]/edit/page.tsx"
    required: false
---
<!-- This file is a Japanese mirror of 404-tsx.md. When updating the English original, update this file too. -->
...
- `frontend/エラー-tsx.md` — エラーバウンダリ
- `frontend/conventions/ルートファイル規約.md`
- `backend/クエリ-ts.md` — fetchXxx の null 返却パターン
