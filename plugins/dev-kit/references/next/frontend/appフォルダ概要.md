...
| Topic | Read |
|---|---|
| Route Group の命名 | `frontend/ルートグループ.md` |
| フィーチャ単位フォルダ | `frontend/フィーチャーフォルダ.md` |
| `[id]/` のルーティング | `frontend/IDルーティング.md` |
| ルートファイル種別（page / layout / error / loading 等） | `frontend/conventions/ルートファイル規約.md` |
| Server / Client Component の境界 | `frontend/conventions/サーバーvsクライアント.md` |
| API ルート構成 | `backend/APIフォルダ概要.md` |
| proxy.ts | `backend/プロキシ.md` |
