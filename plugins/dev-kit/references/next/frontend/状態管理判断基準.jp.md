<!-- This file is a Japanese mirror of 状態管理判断基準.md. When updating the English original, update this file too. -->
# State の置き場所 — 決定フロー
...
| Tool | Reference |
|---|---|
| TanStack Query | `frontend/useQueryパターン.md`, `frontend/useMutationパターン.md`, `frontend/クエリクライアントセットアップ.md` |
| URL state | `frontend/useUrlStateパターン.md` |
| Context | `frontend/コンテキストパターン.md` |
| Zustand | `frontend/Zustandパターン.md` |
| react-hook-form | `frontend/フォームコンポーネント.md`, `frontend/useFormパターン.md` |
