---
name: dev-kit:html-implement
description: >
  Implement a UI screen — turn a mock (from dev-kit:html-mock) or a feature request into real code.
...
# dev-kit:html-implement — Screen Implementation Workflow
...
- This skill assumes a mock already exists or the feature spec is clear. If neither, run
  `/dev-kit:html-mock` first to gather feedback before committing to implementation.
