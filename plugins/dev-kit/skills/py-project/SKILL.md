...
or works on an existing codebase while keeping it aligned with dev-kit standards.
...
Read the entire document. All sections may be relevant depending on the task.
...
See `{plugin_root}/references/python.md` — relevant sections by mode:

**New project (Steps 3–8):**
