...
logger.debug("リクエスト受信", { paths: request.nextUrl.pathname })
...
```json
{"ts":"2026-05-28T12:34:56.789Z","level":"info","component":"api:resources.POST","msg":"request received","ctx":{"path":"/api/v{N}/resources"}}
```
...
- `shared/ロガータグ.md` — Component tag 一覧
- `shared/セキュリティ.md` — センシティブ情報
