...
import { registerResource, editResource, removeResource } from "@/app/api/v{N}/resources/[id]/service"
...
詳細: `frontend/useActionState.md`（クライアント側パターン）
...
- `サービス-ts.md` — 業務ロジック
- `キャッシュ.md` — cacheLife / revalidateTag / updateTag
- `エラーアクションハンドラー.md` — handleActionError 実装
