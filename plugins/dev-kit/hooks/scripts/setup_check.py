"""dev-kit setup_check — SessionStart フック: setup_done フラグを確認する。

setup_done が false / 未設定の場合、/dev-kit:setup-wizard を実行するよう
...
def main() -> None:
    ...
    reason = (
        "**dev-kit プラグインの初回セットアップが完了していません。**\n\n"
        "`/dev-kit:setup-wizard` を実行してセットアップを完了してください。\n\n"
